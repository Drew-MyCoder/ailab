        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="space-y-4 lg:col-span-3">
            <form onSubmit={handleSubmit}>
              <h1 className="lg:text-4xl dark:text-white font-bold pb-6">
              ...
              <div className="flex space-x-2 flex-col gap-5 max-w-md">
                ...
                <Button
                  type="submit"
                  className="lg:max-w-[220px] bg-[#FF6984] dark:text-white"
                  disabled={isSubmitting}
                >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  href="mailto:cleanpigg@gmail.com?subject=Help%20Request%20from%20Website"
                  className="font-bold hover:text-primary transition-colors"
                >
                  Contact
                </Link>
