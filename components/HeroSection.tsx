...
export function HeroSection() {
  ...
  return (
    <motion.section 
      className="w-full py-4 md:py-24 lg:py-10 xl:py-20"
      initial="hidden"
      animate="visible"
          ...
          >
            <div className="m-3 p-3 grid gap-6 lg:mb-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              ...
              <motion.div 
                ...
                variants={itemVariants}
              >
                Ensure fairness, detect biases and validate compliance with our AI auditing platform--built to enhance transparency and uphold ethical standards
